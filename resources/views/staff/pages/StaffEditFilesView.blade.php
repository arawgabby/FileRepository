...
<div class="container mx-auto p-6 bg-white " style="box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <form action="{{ route('staff.updateFile', $file->file_id) }}" method="POST" enctype="multipart/form-data" onsubmit="return validateFileUpload()">
        @csrf
        @method('PUT')
