...
@section('title', 'Outgoing File Requests')
@section('content')

<div class="p-6 bg-white shadow-md">
    <h2 class="text-xl font-bold mb-4 border-b pb-2">Requests I Sent</h2>

    @if($outgoingRequests->isEmpty())
    <p class="text-gray-600">You haven't submitted any file access requests.</p>
    @else
    <table class="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr>
                <td class="px-4 py-2">
                    {{ $users[$request->requested_to]->name ?? 'Unknown User' }}
                </td>
                <td class="px-4 py-2">
