        ...
        <table class="min-w-full bg-white border border-gray-300 rounded-lg">
            ...
            <tbody id="logsTable">
                ...
                <tr class="border-b border-gray-300">
                    <td class="py-3 px-4 flex items-center gap-2 text-center justify-center">
                        <span class="font-semibold text-gray-800">
                            {{ $log->file->filename ?? 'N/A' }}
                        </span>
                    </td>
                    <td class="py-2 px-4 text-center">{{ ucfirst($log->user->name) }}</td>
                    <td class="py-2 px-4 text-center">{{ ucfirst($log->action) }}</td>
                    <td class="py-2 px-4 text-gray-500 text-center">
