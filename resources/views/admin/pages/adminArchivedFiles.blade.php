    ...
    <table class="w-full -collapse  -gray-300">
        ...
        <tbody id="fileTableBody">
            @foreach($fileVersions as $file)
                <tr class="file-row border-b border-gray-300 {{ $loop->odd ? : '' }}">
                    ...
                    <td class="p-4 text-center">
                        ...
                        <a href="{{ route('admin.unarchive.file', $file->version_id ?: $file->file_id) }}" 
                        ...
                        <i class="fas fa-box-open text-white text-lg"></i>
                            ...
                            <form id="archive-form-{{ $file->version_id ?: $file->file_id }}" 
                                action="{{ route('admin.unarchive.file', $file->version_id ?: $file->file_id) }}" 
                                method="POST" 
                                style="display: none;">
                                @csrf
                                @method('PUT')
